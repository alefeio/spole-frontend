...
| P-11   | Participante | —                 | `/arenas`                              | Colar ID de arena do seed; abrir                  | Detalhe da arena                                         | 404 arena inexistente                       | ID arena ativa no seed                      | Sem `GET /arenas` global    |
...
| O-11   | Organizador | detalhe PAID        | Ler aviso de bookings        | Texto indica que gestão de bookings pagos **não** está no front | —                                            | —                              | Limitação MVP           |
